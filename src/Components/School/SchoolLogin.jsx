...
const SchoolLogin = () => {
  ...
  const SchoolLogin = async (e) => {
    const API = "http://localhost:5000/api/schoolLogin";
    e.preventDefault();
    try {
  ...
  return (
    <section className="bg-gray-100 py-20  h-[100vh]">
      ...
      <div className=" flex flex-row gap-8 justify-center items-center mb-4 text-2xl  text-slate-500">
        <Link  to="/Login" className=" hover:border-b-2 border-orange-500">Students</Link>
        <Link to="/SchoolLogin" className=" hover:border-b-2 border-orange-500">Schools</Link>
      </div>
          ...
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
              <div className="mb-10 text-center md:mb-16">
                    <h3 className=" text-2xl text-slate-600 font-bold mx-auto inline-block max-w-[160px]">School Login</h3>
              </div>
              ...
              <p className="text-base text-body-color dark:text-dark-6">
                ...
                <Link  className="text-blue-700  hover:underline" to="/SchoolSignup"> Sign Up</Link>
              </p>
